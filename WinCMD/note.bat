...
wmic /node:tpw704 product get name,version,vendor
rem active office
...
robocopy %Source% %Destination% /E /ZB /COPY:DATSO /XF Thumbs.db /XD %Exclude_Folders% /R:1 /W:1 /V /FP /ETA /LOG+:%Log% /TEE
